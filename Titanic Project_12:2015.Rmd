...
```{r}
train <- read.csv("/Users/Steph/Documents/STAT408/Titanic/train.csv")
train1 <- read.csv("/Users/Steph/Documents/STAT408/Titanic/train.csv", na.strings=c("NA", "NULL"))
test <- read.csv("/Users/Steph/Documents/STAT408/Titanic/test.csv", na.strings=c("NA", "NULL"))
```
...
From the Pclass boxplot it can be determined that not surprisingly an overwhelming number of first class passengers survived, versus second and third class.
